var cols=5,rows=6,colWidth=101,rowHeight=83,heightAdjustment=-25,minX=-1*colWidth,maxX=cols*colWidth,maxY=rows*rowHeight,globalSpeedMultiplyer=15,individualSpeedBooster=1,canvasWidth=505,canvasHeight=606;function Entity(){}function Enemy(a,b){this.sprite="images/enemy-bug.png";this.respawn(a,b)}Enemy.prototype.update=function(a){this.x>maxX||this.x<minX?this.respawn():this.x+=this.speed*a*globalSpeedMultiplyer};
